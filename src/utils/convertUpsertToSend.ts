...
export async function convertIWebMessageInfoToAnyMessageContent(message: proto.IWebMessageInfo): Promise<AnyMessageContent> {
    ...
    const { audioMessage, imageMessage, stickerMessage, documentMessage, documentWithCaptionMessage, conversation, extendedTextMessage, contactMessage, contactsArrayMessage, locationMessage, messageContextInfo, videoMessage } = message.message!;
